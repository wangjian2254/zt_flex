package uicontrol
{
	 ...
	 *  @productversion Flex 3
	 */
	public class FliterComboBox extends ComboBase
		...
		IListItemRenderer
	{
		 ...
		 *  @productversion Flex 3
		 */
		public function FliterComboBox()
		{
			super();
		...
		//		} 
		//		/**
		//		 * 当文本框中最后一个字符被消去时，下拉菜单显示全部数据，输入框为空
		//		 *  @private
		//		 */
		...
		{
			if (FliterComboBox.createAccessibilityImplementation != null)
				FliterComboBox.createAccessibilityImplementation(this);
		}
